...
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, email, password, existingUser, salt, hashedPassword, newUser, error_1;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                token = jsonwebtoken_1.default.sign({ userId: user._id }, 'your-secret-key');
